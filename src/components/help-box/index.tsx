...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Group Owner'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Group Owner', 'Payment Initiator', 'Payment Contributor', 'Group Member'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Loaoaoa`;
  const tenantName = `Group`;
